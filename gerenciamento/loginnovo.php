                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        <?php echo display_error(); ?>
                            ...
                            <h3 class="text-center text-dark">Gerenciamento</h3>
                            ...
                            <div class="form-group">
                                <input type="submit" name="login_btn" class="btn btn-info btn-md" value="Entrar">
                            </div><br>
                            <div id="register-link" class="text-right">
                                <a href="#" class="text-info">Reportar falha</a>
                            </div>
                        </form>
                    </div>
                </div>
