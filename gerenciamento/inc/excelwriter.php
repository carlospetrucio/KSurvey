               ...
               xmlns:x="urn:schemas-microsoft-com:office:excel"
                ...
                <!--[if gte mso 9]><xml>
                 <o:DocumentProperties>
                   <o:Author>Pesquisa TI - Powered by KSurvey (www.kcoder.com.br)</o:Author>
                  <o:LastAuthor>Pesquisa TI - Powered by KSurvey (www.kcoder.com.br)</o:LastAuthor>
                ...
                tr
                    {mso-height-source:auto;font-size:100.0pt;}
                col
                ...
                <table x:str border=10px cellpadding=0 cellspacing=0 style='border-collapse: collapse;table-layout:fixed;'>
                <center><h1>Pesquisa de Satisfação TI - Relatório</h1></center>
EOH;
            return $header;
   }
